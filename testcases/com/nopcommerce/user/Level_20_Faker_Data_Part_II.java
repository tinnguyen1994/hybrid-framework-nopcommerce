...
public class Level_20_Faker_Data_Part_II extends BaseTest {
	private WebDriver driver;
	private String firstName, lastName, existingEmail, validPassword, incorrectPassword;
	...
	public void beforeClass(String browserName) {
		...
		existingEmail = UserData.Register.EMAIL_ADDRESS + generakeFakeNumber() + "@fpt.edu";
		validPassword = UserData.Register.PASSWORD;
		date = UserData.Register.DATE;
