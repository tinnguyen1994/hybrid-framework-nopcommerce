...
public class ExtentManager {
	...
	public synchronized static ExtentReports createExtentReports() {
		ExtentSparkReporter reporter = new ExtentSparkReporter(GlobalConstands.PROJECT_PATH + "/extentV5/ExtentReport.html");
		...
		extentReports.setSystemInfo("JDK version", GlobalConstands.JAVA_VERSION);
